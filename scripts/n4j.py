...
with driver.session() as session:
    ...
    session.write_transaction(load_static_nodes)
    session.write_transaction(load_static_relationships)
    session.write_transaction(load_dynamic_nodes)
    session.write_transaction(load_dynamic_relationships)
    end_time = time.time()

...
"Forum has member Person": '''call apoc.periodic.iterate( 'load csv with headers from "file:///dynamic/forum_hasMember_person_0_0.csv" as row fieldterminator "|" return row', 'match (f:Forum {id: toInteger(row.`Forum.id`)}), (p:Person {id: toInteger(row.`Person.id`)}) create (f)-[:hasMember {creationDate: row.joinDate}]->(p)', {batchSize: 1000, iterateList: true} );''',
    ...
    "Comment is reply of Post": '''call apoc.periodic.iterate( 'load csv with headers from "file:///dynamic/comment_replyOf_post_0_0.csv" as row fieldterminator "|" return row', 'match (c:Comment {id: toInteger(row.`Comment.id`)}), (p:Post {id: toInteger(row.`Post.id`)}) create (c)-[:replyOf]->(p)', {batchSize: 1000, iterateList: true} );''',
...
queries_without_apoc = {
    ...
    "Forum has member Person": '''LOAD CSV WITH HEADERS FROM "file:///dynamic/forum_hasMember_person_0_0.csv" AS row FIELDTERMINATOR "|"  MATCH (f:Forum {id: toInteger(row.`Forum.id`)}), (p:Person {id: toInteger(row.`Person.id`)}) CREATE (f)-[:hasMember {creationDate: row.joinDate}]->(p);''',
    "Forum has moderator Person": '''LOAD CSV WITH HEADERS FROM "file:///dynamic/forum_hasModerator_person_0_0.csv" AS row FIELDTERMINATOR "|"  MATCH (f:Forum {id: toInteger(row.`Forum.id`)}), (p:Person {id: toInteger(row.`Person.id`)}) CREATE (f)-[:hasModerator]->(p);''',
    "Forum has Tag": '''LOAD CSV WITH HEADERS FROM "file:///dynamic/forum_hasTag_tag_0_0.csv" AS row FIELDTERMINATOR "|"  MATCH (f:Forum {id: toInteger(row.`Forum.id`)}), (t:Tag {id: toInteger(row.`Tag.id`)}) CREATE (f)-[:hasTag]->(t);''',
    "Forum container of Post": '''LOAD CSV WITH HEADERS FROM "file:///dynamic/forum_containerOf_post_0_0.csv" AS row FIELDTERMINATOR "|"  MATCH (f:Forum {id: toInteger(row.`Forum.id`)}), (p:Post {id: toInteger(row.`Post.id`)}) CREATE (f)-[:containerOf]->(p);''',
    "Post has Tag": '''LOAD CSV WITH HEADERS FROM "file:///dynamic/post_hasTag_tag_0_0.csv" AS row FIELDTERMINATOR "|"  MATCH (p:Post {id: toInteger(row.`Post.id`)}), (t:Tag {id: toInteger(row.`Tag.id`)}) CREATE (p)-[:hasTag]->(t);''',
    "Post is located in Place": '''LOAD CSV WITH HEADERS FROM "file:///dynamic/post_isLocatedIn_place_0_0.csv" AS row FIELDTERMINATOR "|"  MATCH (p:Post {id: toInteger(row.`Post.id`)}), (pl:Place {id: toInteger(row.`Place.id`)}) CREATE (p)-[:isLocatedIn]->(pl);''',
    "Post has Creator Person": '''LOAD CSV WITH HEADERS FROM "file:///dynamic/post_hasCreator_person_0_0.csv" AS row FIELDTERMINATOR "|"  MATCH (p:Post {id: toInteger(row.`Post.id`)}), (pe:Person {id: toInteger(row.`Person.id`)}) CREATE (p)-[:hasCreator]->(pe);''',
    "Comment has Tag": '''LOAD CSV WITH HEADERS FROM "file:///dynamic/comment_hasTag_tag_0_0.csv" AS row FIELDTERMINATOR "|"  MATCH (c:Comment {id: toInteger(row.`Comment.id`)}), (t:Tag {id: toInteger(row.`Tag.id`)}) CREATE (c)-[:hasTag]->(t);''',
    "Comment is located in Place": '''LOAD CSV WITH HEADERS FROM "file:///dynamic/comment_isLocatedIn_place_0_0.csv" AS row FIELDTERMINATOR "|"  MATCH (c:Comment {id: toInteger(row.`Comment.id`)}), (p:Place {id: toInteger(row.`Place.id`)}) CREATE (c)-[:isLocatedIn]->(p);''',
    "Comment is reply of Comment": '''LOAD CSV WITH HEADERS FROM "file:///dynamic/comment_replyOf_comment_0_0.csv" AS row FIELDTERMINATOR "|"  MATCH (c1:Comment {id: toInteger(row.`Comment1.id`)}), (c2:Comment {id: toInteger(row.`Comment2.id`)}) CREATE (c1)-[:replyOf]->(c2);''',
    "Comment is reply of Post": '''LOAD CSV WITH HEADERS FROM "file:///dynamic/comment_replyOf_post_0_0.csv" AS row FIELDTERMINATOR "|"  MATCH (c:Comment {id: toInteger(row.`Comment.id`)}), (p:Post {id: toInteger(row.`Post.id`)}) CREATE (c)-[:replyOf]->(p);''',
    "Comment has Creator Person": '''LOAD CSV WITH HEADERS FROM "file:///dynamic/comment_hasCreator_person_0_0.csv" AS row FIELDTERMINATOR "|"  MATCH (c:Comment {id: toInteger(row.`Comment.id`)}), (p:Person {id: toInteger(row.`Person.id`)}) CREATE (c)-[:hasCreator]->(p);''',
    "Person Likes (Post)": '''LOAD CSV WITH HEADERS FROM "file:///dynamic/person_likes_post_0_0.csv" AS row FIELDTERMINATOR "|"  MATCH (p:Person {id: toInteger(row.`Person.id`)}), (post:Post {id: toInteger(row.`Post.id`)}) CREATE (p)-[:likes {creationDate: row.creationDate}]->(post);''',
    "Person Likes (Comment)": '''LOAD CSV WITH HEADERS FROM "file:///dynamic/person_likes_comment_0_0.csv" AS row FIELDTERMINATOR "|"  MATCH (p:Person {id: toInteger(row.`Person.id`)}), (c:Comment {id: toInteger(row.`Comment.id`)}) CREATE (p)-[:likes {creationDate: row.creationDate}]->(c);''',
    "Person Knows Person": '''LOAD CSV WITH HEADERS FROM "file:///dynamic/person_knows_person_0_0.csv" AS row FIELDTERMINATOR "|"  MATCH (p1:Person {id: toInteger(row.`Person1.id`)}), (p2:Person {id: toInteger(row.`Person2.id`)}) CREATE (p1)-[:knows {creationDate: row.creationDate}]->(p2);''',
    "Person has Interest Tag": '''LOAD CSV WITH HEADERS FROM "file:///dynamic/person_hasInterest_tag_0_0.csv" AS row FIELDTERMINATOR "|"  MATCH (p:Person {id: toInteger(row.`Person.id`)}), (t:Tag {id: toInteger(row.`Tag.id`)}) CREATE (p)-[:hasInterest]->(t);''',
